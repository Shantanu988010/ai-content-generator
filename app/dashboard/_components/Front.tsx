    ...
    <div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
                <a
                className="block w-full rounded-sm bg-blue-700 px-12 py-3 text-sm font-medium text-white shadow-sm hover:bg-gray-400 focus:ring-3 focus:outline-hidden sm:w-auto"
                href="#"
                >
                Get Started
                </a>
